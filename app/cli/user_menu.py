...
def user_menu(token):
    while True:
        ...
        # UPDATE USER
            ...
            user_choices = [
                f"{u.id} - {u.full_name} ({u.role})" for u in users]
            ...
            full_name = questionary.text(
                "New full name (leave empty to skip):").ask()
            email = questionary.text("New email (leave empty to skip):").ask()
            password = questionary.password(
                "New password (leave empty to skip):").ask()
            role_choice = questionary.select(
                "New role:",
        ...
        # DELETE USER
            ...
            confirm = questionary.confirm(
                "Are you sure you want to delete this user?").ask()
            if confirm:
